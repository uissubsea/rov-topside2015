...
# Form implementation generated from reading ui file 'controller_config.ui'
#
# Created: Fri Mar  6 13:24:31 2015
...
class Ui_controller_config(object):
    def setupUi(self, controller_config):
        ...
        self.thReverse_key.setGeometry(QtCore.QRect(130, 130, 41, 20))
        ...
        self.thForward_key.setGeometry(QtCore.QRect(130, 100, 41, 20))
        ...
        self.thRight_key.setGeometry(QtCore.QRect(330, 40, 41, 20))
        ...
        self.thLeft_key.setGeometry(QtCore.QRect(330, 70, 41, 20))
        ...
        self.thRotateCCW_key.setGeometry(QtCore.QRect(330, 130, 41, 20))
        ...
        self.thRotateCW_key.setGeometry(QtCore.QRect(330, 100, 41, 20))
        self.thRotateCW_key.setText(_fromUtf8(""))
        self.thRotateCW_key.setObjectName(_fromUtf8("thRotateCW_key"))
        self.manipulatorGroupBox = QtGui.QGroupBox(self.tab)
        self.manipulatorGroupBox.setGeometry(QtCore.QRect(20, 190, 591, 211))
        ...
        self.label_8 = QtGui.QLabel(self.manipulatorGroupBox)
        self.label_8.setGeometry(QtCore.QRect(10, 30, 62, 16))
        ...
        self.otherGroupBox = QtGui.QGroupBox(self.tab)
        self.otherGroupBox.setGeometry(QtCore.QRect(20, 410, 591, 111))
        ...
        self.sensitivityTab.addTab(self.tab, _fromUtf8(""))
        self.tab_2 = QtGui.QWidget()
        self.tab_2.setObjectName(_fromUtf8("tab_2"))
        self.groupBox_4 = QtGui.QGroupBox(self.tab_2)
        self.groupBox_4.setGeometry(QtCore.QRect(20, 10, 591, 201))
        self.groupBox_4.setObjectName(_fromUtf8("groupBox_4"))
        self.linear_radiobutton = QtGui.QRadioButton(self.groupBox_4)
        ...
        self.linear_slider = QtGui.QSlider(self.groupBox_4)
        ...
        self.graphicsView_3.setGeometry(QtCore.QRect(330, 30, 251, 161))
        self.graphicsView_3.setObjectName(_fromUtf8("graphicsView_3"))
        self.groupBox_5 = QtGui.QGroupBox(self.tab_2)
        self.groupBox_5.setGeometry(QtCore.QRect(20, 230, 591, 231))
        self.groupBox_5.setObjectName(_fromUtf8("groupBox_5"))
        self.sensitivityTab.addTab(self.tab_2, _fromUtf8(""))

        self.retranslateUi(controller_config)
        self.sensitivityTab.setCurrentIndex(1)
        QtCore.QObject.connect(self.linear_slider, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), self.graphicsView_3.update)
        QtCore.QObject.connect(self.exp_slider, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), self.graphicsView_3.update)
    ...
    def retranslateUi(self, controller_config):
        ...
        self.sensitivityTab.setTabText(self.sensitivityTab.indexOf(self.tab), _translate("controller_config", "Key Bindings", None))
        self.groupBox_4.setTitle(_translate("controller_config", "Throttle", None))
        ...
        self.groupBox_5.setTitle(_translate("controller_config", "Manipulator", None))
        self.sensitivityTab.setTabText(self.sensitivityTab.indexOf(self.tab_2), _translate("controller_config", "Sensitivity", None))
